    ...
    [95433], {
        ...
        681196: (t, e, n) => {
            ...
            class s {
                ...
                setupOnce(t, e) {
                    t(((t, n) => {
                        const r = e().getIntegration(s);
                        return r ? r.enhanceEventWithErrorData(t, n) : t
                    }))
                }
                enhanceEventWithErrorData(t, e = {}) {
                    if (!e.originalException || !(0, r.isError)(e.originalException)) return t;
                    const n = e.originalException.name || e.originalException.constructor.name,
                        c = this._extractErrorData(e.originalException);
                    if (c) {
                        const e = { ...t.contexts
                            },
                            s = (0, i.normalize)(c, this._options.depth);
                        return (0, r.isPlainObject)(s) && ((0, o.addNonEnumerableProperty)(s, "__sentry_skip_normalization__", !0), e[n] = s), { ...t,
                            contexts: e
                        }
                    }
                    return t
                ...
                _extractErrorData(t) {
                    try {
                        ...
                        for (const i of Object.keys(t)) {
                            ...
                            const o = t[i];
                            n[i] = (0, r.isError)(o) ? o.toString() : o
                        }
                        if ("function" == typeof t.toJSON) {
                            const e = t.toJSON();
                            for (const t of Object.keys(e)) {
                                const i = e[t];
                                n[t] = (0, r.isError)(i) ? i.toString() : i
                            }
                        }
                        return n
                    } catch (e) {
                        ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && c.logger.error("Unable to extract extra data from the Error object:", e)
                    }
                    return null
                }
            }
        ...
        336105: (t, e, n) => {
            ...
            class i {
                ...
                constructor(t = {}) {
                    i.prototype.__init.call(this), i.prototype.__init2.call(this), i.prototype.__init3.call(this), t.root && (this._root = t.root), t.prefix && (this._prefix = t.prefix), t.iteratee && (this._iteratee = t.iteratee)
                }
                setupOnce(t, e) {
                    t((t => {
                        const n = e().getIntegration(i);
                ...
                __init3() {
                    this._iteratee = t => {
                        ...
                        const e = /^[A-Z]:\\/.test(t.filename),
                            n = /^\//.test(t.filename);
                        if (e || n) {
                            const n = e ? t.filename.replace(/^[A-Z]:/, "").replace(/\\/g, "/") : t.filename,
                                i = this._root ? (0, r.relative)(this._root, n) : (0, r.basename)(n);
                            t.filename = `${this._prefix}${i}`
                        }
                        return t
                    }
                }
        ...
        197062: (t, e, n) => {
            ...
            function o(t, e) {
                try {
                    ...
                    const u = " > ",
                        f = u.length;
                    let l;
                    for (; n && s++ < r && (l = c(n, e), !("html" === l || s > 1 && a + o.length * f + l.length >= i));) o.push(l), a += l.length, n = n.parentNode;
            ...
            function c(t, e) {
                ...
                else if (n.id && i.push(`#${n.id}`), o = n.className, o && (0, r.isString)(o))
                    for (c = o.split(/\s+/), u = 0; u < c.length; u++) i.push(`.${c[u]}`);
                const l = ["type", "name", "title", "alt"];
                for (u = 0; u < l.length; u++) s = l[u], a = n.getAttribute(s), a && i.push(`[${s}="${a}"]`);
                return i.join("")
            }
        ...
        689735: (t, e, n) => {
            ...
            let s;
            s = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__ ? (0, r.getGlobalSingleton)("logger", c) : c()
        },
        255058: (t, e, n) => {
            function r() {
        ...
        961918: (t, e, n) => {
            ...
            function u(t, e, s = 1 / 0, a = 1 / 0, f = (0, i.memoBuilder)()) {
                const [l, p] = f;
                if (null === e || ["number", "boolean", "string"].includes(typeof e) && !(0, r.isNaN)(e)) return e;
                ...
                if (h && "function" == typeof h.toJSON) try {
                    return u("", h.toJSON(), s - 1, a, f)
                } catch (m) {}
                const g = Array.isArray(e) ? [] : {};
                let y = 0;
                const d = (0, o.convertToPlainObject)(e);
                for (const n in d) {
        ...
        2612: (t, e, n) => {
            n.d(e, {
                addNonEnumerableProperty: () => s,
                convertToPlainObject: () => l,
                dropUndefinedKeys: () => g,
                extractExceptionKeysForMessage: () => h,
                fill: () => c,
                getOriginalFunction: () => u,
                markFunctionWrapped: () => a,
                urlEncode: () => f
            });
            var r = n(197062),
                i = n(844119),
            ...
            function h(t, e = 40) {
                ...
                for (let r = n.length; r > 0; r--) {
                    ...
                    if (!(t.length > e)) return r === n.length ? t : (0, o.truncate)(t, e)
                }
                return ""
            }
            ...
            function y(t, e) {
                if ((0, i.isPlainObject)(t)) {
                    ...
                    const r = {};
                    e.set(t, r);
                    for (const i of Object.keys(t)) void 0 !== t[i] && (r[i] = y(t[i], e));
                    return r
                }
                if (Array.isArray(t)) {
                    const n = e.get(t);
        ...
        216256: (t, e, n) => {
            ...
            function c(...t) {
                ...
                return e = r(e.split("/").filter((t => !!t)), !n).join("/"), (n ? "/" : "") + e || "."
            }
            ...
            function a(t, e) {
                ...
                let a = [];
                for (let c = o; c < n.length; c++) a.push("..");
                return a = a.concat(r.slice(o)), a.join("/")
            }
        ...
        346516: (t, e, n) => {
            n.d(e, {
                createStackParser: () => i,
                getFunctionName: () => s,
                stackParserFromStackParserOptions: () => o
            });
            n(801364);
            const r = 50;
        ...
        294363: (t, e, n) => {
            ...
            function s(t, e) {
                return !!(0, r.isString)(t) && ((0, r.isRegExp)(e) ? e.test(t) : "string" == typeof e && -1 !== t.indexOf(e))
            }
        },
        355384: (t, e, n) => {
            function r(t) {
